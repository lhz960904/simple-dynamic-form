(function(e) {
  ...
  '8Z8O': function(e, t, n) {
    ...
    function M(e) {
      return O ? (O.trackDisposable(e), e) : e;
    }
    var R = (function(e) {
      i(n, e);
      var t = l(n);
    ...
    var U = (function() {
      function e() {
        f(this, e), (this._toDispose = new Set()), (this._isDisposed = !1);
      }
      return (
        d(e, [
          {
            ...
            value: function() {
              this._isDisposed ||
                (P(this), (this._isDisposed = !0), this.clear());
            },
          },
          {
            key: 'clear',
    ...
    U.DISABLE_DISPOSED_WARNING = !1;
    var V = (function() {
      function e() {
        f(this, e), (this._store = new U()), M(this);
      }
      return (
        d(e, [
          {
    ...
    V.None = Object.freeze({ dispose: function() {} });
    var W = n('MNsG');
    function q(e) {
      var t = [],
              ...
              value: function(e) {
                ...
                if (e.seq) {
                  ...
                  s.then(
                    ...
                    function(e) {
                      e.detail instanceof Error && (e.detail = v(e.detail)),
                        t._send({
                          vsWorker: t._workerId,
                          seq: a,
                          res: void 0,
        ...
        return (
          d(e, [
            ...
            },
            {
              key: '_handleMessage',
              value: function(e, t) {
                if (e === $) return this.initialize(t[0], t[1], t[2], t[3]);
                if (
          ...
          },
          {
            ...
            value: function() {
              (this._buff[this._buffLen++] = 128),
                ve(this._buff, this._buffLen),
                this._buffLen > 56 && (this._step(), ve(this._buff));
            ...
            value: function() {
              ...
              for (
                ...
                d < 20
                  ...
                  (s =
                    (pe(u, 5) + o + h + a + t.getUint32(4 * d, !1)) &
                    4294967295),
                  (h = f),
                  (f = l),
                  (l = pe(c, 30)),
    ...
    _e._bigBlock32 = new DataView(new ArrayBuffer(320));
    var Ce = (function() {
      function e(t) {
        f(this, e), (this.source = t);
      }
      return (
        d(e, [
          {
    ...
    function ke(e, t, n) {
      return new Ae(new Ce(e), new Ce(t)).ComputeDiff(n).changes;
    }
    var Se = (function() {
        function e() {
          f(this, e);
        ...
        function e(t, n) {
          var r =
            arguments.length > 2 && void 0 !== arguments[2]
              ? arguments[2]
              : null;
          f(this, e), (this.ContinueProcessingPredicate = r);
                ...
                value: function(
                  ...
                  do {
                    ...
                    A === C || (A < k && u[A - 1] < u[A + 1])
                      ? ((l = u[A + 1]),
                        (d = l - S - r),
                        l < w && _.MarkNextChange(),
                        (w = l),
                        _.AddModifiedElement(l + 1, d),
                        (S = A + 1 - e))
                      : ((l = u[A - 1] + 1),
                        (d = l - S - r),
                        l < w && _.MarkNextChange(),
                        (w = l - 1),
                        _.AddOriginalElement(l, d + 1),
                        (S = A - 1 - e)),
                      x >= 0 &&
                        ((u = this.m_forwardHistory[x]),
                        (e = u[0]),
                        (C = 1),
                        (k = u.length - 1));
                  } while (--x >= -1);
                  if (((y = _.getReverseChanges()), v[0])) {
                    ...
                    if (null !== y && y.length > 0) {
                      var L = y[y.length - 1];
                      (E = Math.max(E, L.getOriginalEnd())),
                        (N = Math.max(N, L.getModifiedEnd()));
                    }
                    b = [new oe(E, f - E + 1, N, m - N + 1)];
                  } else {
                    (_ = new xe()),
                      (C = o),
                      (k = a),
                    ...
                    do {
                      ...
                      T === C || (T < k && c[T - 1] >= c[T + 1])
                        ? ((l = c[T + 1] - 1),
                          ...
                          l > w && _.MarkNextChange(),
                          (w = l + 1),
                          _.AddOriginalElement(l + 1, d + 1),
                          (S = T + 1 - i))
                        : ((l = c[T - 1]),
                          (d = l - S - s),
                          l > w && _.MarkNextChange(),
                          (w = l),
                          _.AddModifiedElement(l + 1, d + 1),
                          (S = T - 1 - i)),
                        x >= 0 &&
                          ((c = this.m_reverseHistory[x]),
                          (i = c[0]),
                          (C = 1),
                          (k = c.length - 1));
                    } while (--x >= -1);
                ...
                value: function(e, t, n, r, i, o, a) {
                  ...
                  for (var S = 1; S <= d / 2 + 1; S++) {
                    ...
                    if (
                      ...
                      !this.ContinueProcessingPredicate(w, N)
                    )
                      return (
                        (a[0] = !0),
                        (i[0] = w),
                    ...
                    for (var L = f; L <= h; L += 2) {
                      ...
                      while (s > e && u > n && this.ElementsAreEqual(s, u))
                        s--, u--;
                      if (((p[L] = s), k && Math.abs(L - v) <= S && s <= g[L]))
                        return (
                          (i[0] = s),
                          (o[0] = u),
                          T >= g[L] && S <= 1448
                    ...
                    if (S <= 1447) {
                      ...
                      (O[0] = v - c + 1),
                        we.Copy2(g, c, O, 1, l - c + 1),
                        this.m_forwardHistory.push(O),
                        (O = new Int32Array(h - f + 2)),
                        (O[0] = y - f + 1),
                        we.Copy2(p, f, O, 1, h - f + 1),
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  for (var u = e.length - 1; u >= 0; u--) {
                    ...
                    (c.originalStart -= g), (c.modifiedStart -= g);
                  }
                  if (this._hasStrings)
                    for (var C = 1, k = e.length; C < k; C++) {
                      var S = e[C - 1],
                        w = e[C],
                        x =
                          w.originalStart - S.originalStart - S.originalLength,
                        A = S.originalStart,
                        E = w.originalStart + w.originalLength,
                        N = E - A,
                        L = S.modifiedStart,
                        T = w.modifiedStart + w.modifiedLength,
                        O = T - L;
                      if (x < 5 && N < 20 && O < 20) {
                        ...
                        if (I) {
                          var P = ie(I, 2),
                            M = P[0],
                            R = P[1];
                          (M === S.originalStart + S.originalLength &&
                            R === S.modifiedStart + S.modifiedLength) ||
                            ((S.originalLength = M - S.originalStart),
                            (S.modifiedLength = R - S.modifiedStart),
                            (w.originalStart = M + x),
                            (w.modifiedStart = R + x),
                            (w.originalLength = E - w.originalStart),
                            (w.modifiedLength = T - w.modifiedStart));
                        }
                      }
                    }
                  return e;
              ...
              },
              {
                ...
                value: function(e, t, n, r, i) {
                  ...
                  for (
                    ...
                    for (var f = n; f < a; f++) {
                      var h = this._contiguousSequenceScore(l, f, i);
                      h > 0 && h > s && ((s = h), (u = l), (c = f));
                    }
                  return s > 0 ? [u, c] : null;
                },
              ...
              },
              {
                ...
                value: function(e, t) {
                  ...
                  if (this.ChangesOverlap(e[e.length - 1], t[0], n)) {
                    ...
                    return (
                      we.Copy(e, 0, r, 0, e.length - 1),
                      (r[e.length - 1] = n[0]),
                      we.Copy(t, 1, r, e.length, t.length - 1),
                      r
                    );
                  }
                  var i = new Array(e.length + t.length);
                  return (
                    we.Copy(e, 0, i, 0, e.length),
                    we.Copy(t, 0, i, e.length, t.length),
                    i
                  );
                },
              },
    ...
    var Ke = {
        ...
        normalize: function(e) {
          ...
          var n,
            ...
            i = !1,
            o = e.charCodeAt(0);
          if (1 === t) return Ve(o) ? '\\' : e;
          if (Ue(o))
            if (((i = !0), Ue(e.charCodeAt(1)))) {
              var a = 2,
                s = a;
              while (a < t && !Ue(e.charCodeAt(a))) a++;
              if (a < t && a !== s) {
                var u = e.slice(s, a);
                s = a;
                while (a < t && Ue(e.charCodeAt(a))) a++;
            ...
            We(o) &&
              ...
              ((n = e.slice(0, 2)),
              (r = 2),
              t > 2 && Ue(e.charCodeAt(2)) && ((i = !0), (r = 3)));
          var c = r < t ? qe(e.slice(r), !i, '\\', Ue) : '';
          return (
            0 !== c.length || i || (c = '.'),
            c.length > 0 && Ue(e.charCodeAt(t - 1)) && (c += '\\'),
            void 0 === n
              ? i
                ? '\\'.concat(c)
                : c
        ...
        isAbsolute: function(e) {
          ...
          return (
            Ue(n) ||
            (t > 2 && We(n) && e.charCodeAt(1) === Re && Ue(e.charCodeAt(2)))
          );
        },
        join: function() {
          ...
          var i = !0,
            o = 0;
          if ('string' === typeof t && Ue(t.charCodeAt(0))) {
            ++o;
            var a = t.length;
            a > 1 &&
              Ue(t.charCodeAt(1)) &&
              (++o, a > 2 && (Ue(t.charCodeAt(2)) ? ++o : (i = !1)));
          }
          if (i) {
            while (o < e.length && Ue(e.charCodeAt(o))) o++;
            o >= 2 && (e = '\\'.concat(e.slice(o)));
          }
          return Ke.normalize(e);
        },
        relative: function(e, t) {
          ...
          if (((e = n.toLowerCase()), (t = r.toLowerCase()), e === t))
            return '';
          var i = 0;
          while (i < e.length && e.charCodeAt(i) === Me) i++;
          var o = e.length;
          while (o - 1 > i && e.charCodeAt(o - 1) === Me) o--;
          var a = o - i,
            s = 0;
          while (s < t.length && t.charCodeAt(s) === Me) s++;
          var u = t.length;
          while (u - 1 > s && t.charCodeAt(u - 1) === Me) u--;
          ...
          if (h !== l) {
            ...
            if (c > l) {
              if (t.charCodeAt(s + h) === Me) return r.slice(s + h + 1);
              if (2 === h) return r.slice(s + h);
            }
            a > l &&
              (e.charCodeAt(i + h) === Me ? (f = h) : 2 === h && (f = 3)),
              -1 === f && (f = 0);
          }
          var m = '';
          for (h = i + f + 1; h <= o; ++h)
            (h !== o && e.charCodeAt(h) !== Me) ||
              (m += 0 === m.length ? '..' : '\\..');
          return (
            (s += f),
            m.length > 0
              ? ''.concat(m).concat(r.slice(s, u))
              : (r.charCodeAt(s) === Me && ++s, r.slice(s, u))
          );
        },
        ...
        dirname: function(e) {
          ...
          if (Ue(i)) {
            ...
            We(i) &&
              e.charCodeAt(1) === Re &&
              ((n = t > 2 && Ue(e.charCodeAt(2)) ? 3 : 2), (r = n));
          for (var s = -1, u = !0, c = t - 1; c >= r; --c)
            if (Ue(e.charCodeAt(c))) {
              if (!u) {
                s = c;
                break;
              }
      ...
      $e = {
        resolve: function() {
          ...
          return (
            (e = qe(e, !t, '/', Ve)), t ? '/'.concat(e) : e.length > 0 ? e : '.'
          );
        },
        normalize: function(e) {
          if ((Fe(e, 'path'), 0 === e.length)) return '.';
          var t = e.charCodeAt(0) === Pe,
            n = e.charCodeAt(e.length - 1) === Pe;
          return (
            (e = qe(e, !t, '/', Ve)),
            0 === e.length
              ? t
        ...
        isAbsolute: function(e) {
          return Fe(e, 'path'), e.length > 0 && e.charCodeAt(0) === Pe;
        },
        join: function() {
          if (0 === arguments.length) return '.';
          ...
          return void 0 === e ? '.' : $e.normalize(e);
        },
        relative: function(e, t) {
          if ((Fe(e, 'from'), Fe(t, 'to'), e === t)) return '';
          if (((e = $e.resolve(e)), (t = $e.resolve(t)), e === t)) return '';
          for (
            var n = 1,
              r = e.length,
              i = r - n,
            ...
            if (l !== t.charCodeAt(o + c)) break;
            l === Pe && (u = c);
          }
          if (c === s)
            if (a > s) {
              if (t.charCodeAt(o + c) === Pe) return t.slice(o + c + 1);
              if (0 === c) return t.slice(o + c);
            } else
              i > s &&
                (e.charCodeAt(n + c) === Pe ? (u = c) : 0 === c && (u = 0));
          var f = '';
          for (c = n + u + 1; c <= r; ++c)
            (c !== r && e.charCodeAt(c) !== Pe) ||
              (f += 0 === f.length ? '..' : '/..');
          return ''.concat(f).concat(t.slice(o + u));
        },
        toNamespacedPath: function(e) {
          return e;
        },
        dirname: function(e) {
          if ((Fe(e, 'path'), 0 === e.length)) return '.';
          for (
            var t = e.charCodeAt(0) === Pe, n = -1, r = !0, i = e.length - 1;
            i >= 1;
            --i
          )
            if (e.charCodeAt(i) === Pe) {
              if (!r) {
                n = i;
                break;
              }
    ...
    ($e.win32 = Ke.win32 = Ke), ($e.posix = Ke.posix = $e);
    'win32' === Ee['c'] ? Ke.normalize : $e.normalize,
      'win32' === Ee['c'] ? Ke.resolve : $e.resolve,
      'win32' === Ee['c'] ? Ke.relative : $e.relative,
      'win32' === Ee['c'] ? Ke.dirname : $e.dirname,
      'win32' === Ee['c'] ? Ke.basename : $e.basename,
      'win32' === Ee['c'] ? Ke.extname : $e.extname,
      'win32' === Ee['c'] ? Ke.sep : $e.sep;
    var He,
      Ye = /^\w[\w\d+.-]*$/,
      Ge = /^\//,
      ze = /^\/\//;
    ...
    var Ze = '',
      ...
      nt = (function() {
        function e(t, n, r, i, o) {
          ...
          f(this, e),
            'object' === typeof t
              ? ((this.scheme = t.scheme || Ze),
                (this.authority = t.authority || Ze),
                (this.path = t.path || Ze),
                (this.query = t.query || Ze),
                (this.fragment = t.fragment || Ze))
              : ((this.scheme = Qe(t, a)),
                (this.authority = n || Ze),
                (this.path = Xe(this.scheme, r || Ze)),
                (this.query = i || Ze),
                (this.fragment = o || Ze),
                Je(this, a));
        }
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  var t = e.scheme,
                    ...
                    o = e.fragment;
                  return (
                    void 0 === t ? (t = this.scheme) : null === t && (t = Ze),
                    void 0 === n
                      ? (n = this.authority)
                      : null === n && (n = Ze),
                    void 0 === r ? (r = this.path) : null === r && (r = Ze),
                    void 0 === i ? (i = this.query) : null === i && (i = Ze),
                    void 0 === o ? (o = this.fragment) : null === o && (o = Ze),
                    t === this.scheme &&
                    n === this.authority &&
                    r === this.path &&
                    i === this.query &&
              ...
              },
              {
                ...
                value: function(t) {
                  ...
                  for (
                    ...
                    a[s - 1] = arguments[s];
                  W['d'] && 'file' === t.scheme
                    ? (n = e.file((r = Ke).join.apply(r, [ut(t, !0)].concat(a)))
                        .path)
                    : (n = (i = $e).join.apply(i, [t.path].concat(a)));
          ...
          d(n, [
            ...
            },
            {
              ...
              value: function() {
                ...
                return e
                  ? ct(this, !0)
                  : (this._formatted || (this._formatted = ct(this, !1)),
                    this._formatted);
              },
            },
            {
    ...
    var dt = (function() {
        function e(t, n) {
          f(this, e), (this.lineNumber = t), (this.column = n);
        }
        return (
          d(
            e,
              ...
              value: function(t, n, r, i, o, a, s) {
                ...
                if (
                  ...
                  var d = r.createCharSequence(
                    ...
                    g = pt(d, m, o, !0).changes;
                  s && (g = _t(g)), (h = []);
                  for (var p = 0, v = g.length; p < v; p++)
                    h.push(bt.createFromDiffChange(g[p], d, m));
                }
      ...
      kt = (function() {
        function e(t, n, r) {
          f(this, e),
            ...
            (this.original = new vt(t)),
            (this.modified = new vt(n)),
            (this.continueLineDiff = xt(r.maxComputationTime)),
            (this.continueCharDiff = xt(
              ...
              value: function(e, t, n, r, i, o, a) {
                ...
                return (
                  ...
                  u.originalEndLineNumber + 1 === t &&
                    ...
                    this.shouldComputeCharChanges &&
                      u.charChanges &&
                      u.charChanges.push(new bt(t, n, t, r, i, o, i, a)),
                    !0)
                );
              },
            },
    ...
    var Nt = function e(t, n) {
        f(this, e), (this.index = t), (this.remainder = n);
      },
      Lt = (function() {
        function e(t) {
          f(this, e),
        ...
        return (
          d(e, [
            ...
            },
            {
              ...
              value: function(e) {
                return e < 0 ? 0 : ((e = Et(e)), this._getAccumulatedValue(e));
              },
            },
            {
    ...
    function jt(e, t, n, r) {
      ...
      for (var a = Date.now(), s = e - 1 - r, u = -1, c = null, l = 1; ; l++) {
        if (Date.now() - a >= i.timeBudget) break;
        var f = s - i.windowSize * l;
    ...
    var Ft = (function() {
      ...
      Vt = (function() {
        function e(t) {
          ...
          n++, r++;
          for (var l = new Ut(r, n, 0), h = 0, d = t.length; h < d; h++) {
            var m = ie(t[h], 3),
              g = m[0],
              p = m[1],
              v = m[2];
          ...
          (this._states = l), (this._maxCharCode = n);
        }
        return (
          d(e, [
            {
    ...
    function Kt() {
      if (null === Bt) {
        ...
        for (
          ...
          Bt.set(e.charCodeAt(t), 1);
        for (var n = '.,;', r = 0; r < n.length; r++)
          Bt.set(n.charCodeAt(r), 2);
      }
      return Bt;
    }
    var $t = (function() {
              ...
              for (
                ...
                while (c < u) {
                  ...
                  if (13 === h) {
                    ...
                    var _ = void 0;
                    91 === y ? ((m = !0), (_ = 0)) : (_ = r.get(y)),
                      1 === _ ? (v = !0) : (h = 13);
                  } else (h = n.nextState(h, y)), 0 === h && (v = !0);
                  v &&
                    ((h = 1),
                    (d = !1),
                    (m = !1),
    ...
    var zt,
      Jt = (function() {
        function e() {
          f(this, e),
            (this._first = Gt.Undefined),
            (this._last = Gt.Undefined),
            (this._size = 0);
        }
        return (
          d(e, [
                ...
                if (e.prev !== Gt.Undefined && e.next !== Gt.Undefined) {
                  ...
                  e.prev === Gt.Undefined && e.next === Gt.Undefined
                    ...
                    ? ((this._last = this._last.prev),
                      (this._last.next = Gt.Undefined))
                    : e.prev === Gt.Undefined &&
                      ((this._first = this._first.next),
                      (this._first.prev = Gt.Undefined));
                this._size -= 1;
              },
            },
            {
              key: Symbol.iterator,
              value: L.a.mark(function e() {
                var t;
                return L.a.wrap(
                  function(e) {
                    while (1)
      ...
      Qt = W['a'].performance && 'function' === typeof W['a'].performance.now,
      Xt = (function() {
        function e(t) {
          f(this, e),
            (this._highResolution = Qt && t),
        ...
        d(e, [
          {
            key: 'start',
            value: function(e) {
              (this._stopWatch = new Xt(!0)), (this._listenerCount = e);
            },
          },
          {
            key: 'stop',
          ...
          d(e, [
                ...
                return (
                  this._event ||
                    (this._event = function(n, r, i) {
                      var o;
                      t._listeners || (t._listeners = new Jt());
            ...
            },
            {
              ...
              value: function(e) {
                var t, n;
                if (this._listeners) {
                  this._deliveryQueue || (this._deliveryQueue = new Jt());
                  var r,
                    i = k(this._listeners);
                  try {
                    for (i.s(); !(r = i.n()).done; ) {
    ...
    var an,
      sn = (function() {
        function e() {
          f(this, e), (this._isCancelled = !1), (this._emitter = null);
        }
        return (
          d(e, [
            {
    ...
    (function() {
      function e(e, t) {
        ...
        ln.define(e, t), fn.define(e, n), hn.define(e, r);
      }
      e(0, 'unknown'),
        e(1, 'Backspace'),
        e(2, 'Tab'),
      ...
      (function(e) {
        ...
        function o(e) {
          return fn.strToKeyCode(e) || hn.strToKeyCode(e);
        }
        (e.toString = t),
          (e.fromString = n),
        ...
        return (
          d(n, [
            ...
            },
            {
              ...
              value: function(e, t) {
                var n = jt(e.column, Mt(t), this._lines[e.lineNumber - 1], 0);
                return n
                  ? new mt(
                      e.lineNumber,
                      n.startColumn,
            ...
            },
            {
              ...
              value: function(t, n) {
                return Xn(
                  ...
                  void 0,
                  L.a.mark(function r() {
                    var i, o, a, s, u, c, l, f, h, d, m, g, p, v, y, b, _, C;
                    return L.a.wrap(
                      function(r) {
                        while (1)
                          switch ((r.prev = r.next)) {
                            ...
                            case 24:
                              (m = ke(d, f, !1)),
                                (g = i.offsetAt(mt.lift(l).getStartPosition())),
                                (p = k(m));
                              try {
                                for (p.s(); !(v = p.n()).done; )
                                  (y = v.value),
                        ...
                        while (1)
                          switch ((o.prev = o.next)) {
                            ...
                            case 6:
                              ...
                              if (((f = l.value), (h = this._getModel(f)), h)) {
                                o.next = 11;
                                break;
                              }
                              return o.abrupt('continue', 31);
                            case 11:
                              (d = k(h.words(s))), (o.prev = 12), d.s();
                            case 14:
                              if ((m = d.n()).done) {
                                o.next = 23;
                                break;
                          ...
                          switch ((o.prev = o.next)) {
                            ...
                            case 9:
                              return (
                                ...
                                (f = Yt.INSTANCE.navigateValueSet(
                                  t,
                                  u,
                                  c,
                                  l,
    ...
    (er._diffLimit = 1e5),
      ...
      'function' === typeof importScripts && (W['a'].monaco = Qn());
    var tr,
      nr = !1;
    function rr(e) {
      if (!nr) {
    ...
    function ir(e, t) {
      ...
      function m() {
        ...
        if (48 === e.charCodeAt(r)) r++;
          ...
          r++;
          while (r < e.length && sr(e.charCodeAt(r))) r++;
        }
        if (r < e.length && 46 === e.charCodeAt(r)) {
          if ((r++, !(r < e.length && sr(e.charCodeAt(r)))))
        ...
        switch (t) {
          ...
          case 47:
            ...
            if (42 === e.charCodeAt(r + 1)) {
              ...
              return p || (r++, (f = 1)), (i = e.substring(h, r)), (a = 13);
            }
    ...
    function ur(e, t, n) {
      var r, i, o, a, s;
      if (t) {
        (a = t.offset), (s = a + t.length), (o = a);
        while (o > 0 && !hr(e, o - 1)) o--;
        var u = s;
        while (u < e.length && !hr(e, u)) u++;
        (i = e.substring(o, u)), (r = lr(i, n));
      } else (i = e), (r = 0), (o = 0), (a = 0), (s = e.length);
      var c,
        l = fr(n, e),
        f = !1,
        h = 0;
      c = n.insertSpaces ? cr(' ', n.tabSize || 4) : '\t';
      var d = ir(i, !1),
        m = !1;
      function g() {
        return l + cr(c, r + h);
      ...
      function p() {
        var e = d.scan();
        f = !1;
        while (15 === e || 14 === e) (f = f || 14 === e), (e = d.scan());
      ...
      function y(n, r, i) {
        m ||
          (t && !(r < s && i > a)) ||
          e.substring(r, i) === n ||
          v.push({ offset: r, length: i - r, content: n });
      }
      var b = p();
      if (17 !== b) {
      ...
      while (17 !== b) {
        var k = d.getTokenOffset() + d.getTokenLength() + o,
          S = p(),
          w = '',
          x = !1;
        while (!f && (12 === S || 13 === S)) {
          var A = d.getTokenOffset() + o;
          y(' ', k, A),
            (k = d.getTokenOffset() + d.getTokenLength() + o),
            (x = 12 === S),
            (w = x ? g() : ''),
            (S = p());
        }
        if (2 === S) 1 !== b && (h--, (w = g()));
        else if (4 === S) 3 !== b && (h--, (w = g()));
        else {
          switch (b) {
            case 3:
            case 1:
    ...
    function dr(e, t, n) {
      void 0 === t && (t = []), void 0 === n && (n = tr.DEFAULT);
      var r = null,
        i = [],
        o = [];
      function a(e) {
    ...
    function Qr(e, t) {
      ...
      if (Array.isArray(e)) {
        if (e.length !== t.length) return !1;
        for (n = 0; n < e.length; n++) if (!Qr(e[n], t[n])) return !1;
      } else {
        var i = [];
        for (r in e) i.push(r);
        i.sort();
        var o = [];
        for (r in t) o.push(r);
        if ((o.sort(), !Qr(i, o))) return !1;
        for (n = 0; n < i.length; n++) if (!Qr(e[i[n]], t[i[n]])) return !1;
      }
      return !0;
    }
    function Xr(e) {
    ...
    (function(e) {
      ...
      (function(e) {
        function t(e, t) {
          return (
            e === Number.MAX_VALUE && (e = _r.MAX_VALUE),
            t === Number.MAX_VALUE && (t = _r.MAX_VALUE),
            { line: e, character: t }
          );
        }
        function n(e) {
      ...
      (function(e) {
        function t(e, t, n, r) {
          if (
            ...
            return { start: Cr.create(e, t), end: Cr.create(n, r) };
          if (Cr.is(e) && Cr.is(t)) return { start: e, end: t };
          throw new Error(
        ...
        function n(e) {
          var t = e;
          return Ri.objectLiteral(t) && Cr.is(t.start) && Cr.is(t.end);
        }
        (e.create = t), (e.is = n);
      })(kr || (kr = {})),
      (function(e) {
        ...
        function n(e) {
          ...
          return (
            Ri.defined(t) &&
            kr.is(t.range) &&
            (Ri.string(t.uri) || Ri.undefined(t.uri))
          );
        }
        (e.create = t), (e.is = n);
      })(Sr || (Sr = {})),
      (function(e) {
        ...
        function n(e) {
          ...
          return (
            Ri.defined(t) &&
            kr.is(t.targetRange) &&
            Ri.string(t.targetUri) &&
            (kr.is(t.targetSelectionRange) ||
              Ri.undefined(t.targetSelectionRange)) &&
            (kr.is(t.originSelectionRange) ||
              Ri.undefined(t.originSelectionRange))
          );
        }
        (e.create = t), (e.is = n);
      })(wr || (wr = {})),
      (function(e) {
        ...
        function n(e) {
          var t = e;
          return (
            Ri.numberRange(t.red, 0, 1) &&
            Ri.numberRange(t.green, 0, 1) &&
            Ri.numberRange(t.blue, 0, 1) &&
            Ri.numberRange(t.alpha, 0, 1)
          );
        }
        (e.create = t), (e.is = n);
      })(xr || (xr = {})),
      (function(e) {
        ...
        function n(e) {
          var t = e;
          return kr.is(t.range) && xr.is(t.color);
        }
        (e.create = t), (e.is = n);
      })(Ar || (Ar = {})),
      (function(e) {
        ...
        function n(e) {
          ...
          return (
            Ri.string(t.label) &&
            (Ri.undefined(t.textEdit) || jr.is(t)) &&
            (Ri.undefined(t.additionalTextEdits) ||
              Ri.typedArray(t.additionalTextEdits, jr.is))
          );
        }
        (e.create = t), (e.is = n);
      })(Er || (Er = {})),
      ...
      (function(e) {
        function t(e, t, n, r, i) {
          ...
          return (
            Ri.defined(n) && (o.startCharacter = n),
            Ri.defined(r) && (o.endCharacter = r),
            Ri.defined(i) && (o.kind = i),
            o
          );
        }
        function n(e) {
          var t = e;
          return (
            Ri.uinteger(t.startLine) &&
            Ri.uinteger(t.startLine) &&
            (Ri.undefined(t.startCharacter) || Ri.uinteger(t.startCharacter)) &&
            (Ri.undefined(t.endCharacter) || Ri.uinteger(t.endCharacter)) &&
            (Ri.undefined(t.kind) || Ri.string(t.kind))
          );
        }
        (e.create = t), (e.is = n);
      })(Lr || (Lr = {})),
      (function(e) {
        ...
        function n(e) {
          var t = e;
          return Ri.defined(t) && Sr.is(t.location) && Ri.string(t.message);
        }
        (e.create = t), (e.is = n);
      })(Tr || (Tr = {})),
      (function(e) {
      ...
      (function(e) {
        function t(e) {
          var t = e;
          return void 0 !== t && null !== t && Ri.string(t.href);
        }
        e.is = t;
      })(Pr || (Pr = {})),
      (function(e) {
        function t(e, t, n, r, i, o) {
          ...
          return (
            Ri.defined(n) && (a.severity = n),
            Ri.defined(r) && (a.code = r),
            Ri.defined(i) && (a.source = i),
            Ri.defined(o) && (a.relatedInformation = o),
            a
          );
        }
        function n(e) {
          ...
          return (
            ...
            kr.is(n.range) &&
            Ri.string(n.message) &&
            (Ri.number(n.severity) || Ri.undefined(n.severity)) &&
            (Ri.integer(n.code) || Ri.string(n.code) || Ri.undefined(n.code)) &&
            (Ri.undefined(n.codeDescription) ||
              Ri.string(
                null === (t = n.codeDescription) || void 0 === t
                  ? void 0
                  : t.href,
              )) &&
            (Ri.string(n.source) || Ri.undefined(n.source)) &&
            (Ri.undefined(n.relatedInformation) ||
              Ri.typedArray(n.relatedInformation, Tr.is))
          );
        }
        (e.create = t), (e.is = n);
      })(Mr || (Mr = {})),
      (function(e) {
        function t(e, t) {
          ...
          return Ri.defined(n) && n.length > 0 && (i.arguments = n), i;
        }
        function n(e) {
          var t = e;
          return Ri.defined(t) && Ri.string(t.title) && Ri.string(t.command);
        }
        (e.create = t), (e.is = n);
      })(Rr || (Rr = {})),
      (function(e) {
        ...
        function i(e) {
          var t = e;
          return Ri.objectLiteral(t) && Ri.string(t.newText) && kr.is(t.range);
        }
      ...
      (function(e) {
        ...
        function n(e) {
          ...
          return (
            ...
            Ri.objectLiteral(t) &&
            Ri.string(t.label) &&
            (Ri['boolean'](t.needsConfirmation) ||
              void 0 === t.needsConfirmation) &&
            (Ri.string(t.description) || void 0 === t.description)
          );
        }
        (e.create = t), (e.is = n);
      })(Dr || (Dr = {})),
      ...
      (function(e) {
        ...
        function i(e) {
          var t = e;
          return jr.is(t) && (Dr.is(t.annotationId) || Fr.is(t.annotationId));
        }
        (e.replace = t), (e.insert = n), (e.del = r), (e.is = i);
      })(Ur || (Ur = {})),
      (function(e) {
        ...
        function n(e) {
          var t = e;
          return (
            Ri.defined(t) && ii.is(t.textDocument) && Array.isArray(t.edits)
          );
        }
        (e.create = t), (e.is = n);
      })(Vr || (Vr = {})),
          ...
          return (
            ...
            (void 0 === t.options ||
              ((void 0 === t.options.overwrite ||
                Ri['boolean'](t.options.overwrite)) &&
                (void 0 === t.options.ignoreIfExists ||
                  Ri['boolean'](t.options.ignoreIfExists)))) &&
            (void 0 === t.annotationId || Fr.is(t.annotationId))
          );
        }
        (e.create = t), (e.is = n);
      })(Wr || (Wr = {})),
          ...
          return (
            ...
            (void 0 === t.options ||
              ((void 0 === t.options.recursive ||
                Ri['boolean'](t.options.recursive)) &&
                (void 0 === t.options.ignoreIfNotExists ||
                  Ri['boolean'](t.options.ignoreIfNotExists)))) &&
            (void 0 === t.annotationId || Fr.is(t.annotationId))
          );
        }
        (e.create = t), (e.is = n);
          ...
          return (
            ...
            (void 0 === t.documentChanges ||
              t.documentChanges.every(function(e) {
                return Ri.string(e.kind)
                  ? Wr.is(e) || qr.is(e) || Br.is(e)
                  : Vr.is(e);
              }))
          );
        }
      ...
      Object.defineProperty(e.prototype, 'edit', {
          ...
          if (ii.is(e)) {
            ...
            if (!n) {
              ...
              this._workspaceEdit.documentChanges.push(i),
                (n = new Ii(r, this._changeAnnotations)),
        ...
        (e.prototype.initDocumentChanges = function() {
          void 0 === this._workspaceEdit.documentChanges &&
            ...
            ((this._changeAnnotations = new Pi()),
        ...
        (e.prototype.createFile = function(e, t, n) {
          ...
          var r, i, o;
          if (
            (Dr.is(t) || Fr.is(t) ? (r = t) : (n = t),
            void 0 === r
              ? (i = Wr.create(e, n))
              : ((o = Fr.is(r) ? r : this._changeAnnotations.manage(r)),
                (i = Wr.create(e, n, o))),
            this._workspaceEdit.documentChanges.push(i),
            void 0 !== o)
          )
        ...
        (e.prototype.renameFile = function(e, t, n, r) {
          ...
          var i, o, a;
          if (
            (Dr.is(n) || Fr.is(n) ? (i = n) : (r = n),
            void 0 === i
              ? (o = qr.create(e, t, r))
              : ((a = Fr.is(i) ? i : this._changeAnnotations.manage(i)),
                (o = qr.create(e, t, r, a))),
    ...
    (function(e) {
      ...
      function n(e) {
        var t = e;
        return Ri.defined(t) && Ri.string(t.uri);
      }
      (e.create = t), (e.is = n);
    })(ni || (ni = {})),
      (function(e) {
        ...
        function n(e) {
          var t = e;
          return Ri.defined(t) && Ri.string(t.uri) && Ri.integer(t.version);
        }
        (e.create = t), (e.is = n);
      })(ri || (ri = {})),
      (function(e) {
        ...
        function n(e) {
          ...
          return (
            Ri.defined(t) &&
            Ri.string(t.uri) &&
            (null === t.version || Ri.integer(t.version))
          );
        }
        (e.create = t), (e.is = n);
      })(ii || (ii = {})),
      (function(e) {
        ...
        function n(e) {
          ...
          return (
            Ri.defined(t) &&
            Ri.string(t.uri) &&
            Ri.string(t.languageId) &&
            Ri.integer(t.version) &&
            Ri.string(t.text)
          );
        }
        (e.create = t), (e.is = n);
      ...
      (function(e) {
        function t(e) {
          var t = e;
          return Ri.objectLiteral(e) && ai.is(t.kind) && Ri.string(t.value);
        }
        e.is = t;
      })(si || (si = {})),
      (function(e) {
      ...
      (function(e) {
        ...
        function n(e) {
          var t = e;
          return (
            t && Ri.string(t.newText) && kr.is(t.insert) && kr.is(t.replace)
          );
        }
        (e.create = t), (e.is = n);
      })(fi || (fi = {})),
      ...
      (function(e) {
        ...
        function n(e) {
          ...
          return (
            Ri.string(t) ||
            (Ri.objectLiteral(t) && Ri.string(t.language) && Ri.string(t.value))
          );
        }
      ...
      (function(e) {
        function t(e) {
          ...
          return (
            ...
            (si.is(t.contents) ||
              gi.is(t.contents) ||
              Ri.typedArray(t.contents, gi.is)) &&
            (void 0 === e.range || kr.is(e.range))
          );
        }
        e.is = t;
      })(pi || (pi = {})),
      ...
      (function(e) {
        function t(e, t) {
          ...
          var i = { label: e };
          return (
            Ri.defined(t) && (i.documentation = t),
            Ri.defined(n) ? (i.parameters = n) : (i.parameters = []),
            i
          );
        }
        e.create = t;
      ...
      (function(e) {
        ...
        function n(e) {
          ...
          return (
            ...
            Ri.number(t.kind) &&
            kr.is(t.range) &&
            kr.is(t.selectionRange) &&
            (void 0 === t.detail || Ri.string(t.detail)) &&
            (void 0 === t.deprecated || Ri['boolean'](t.deprecated)) &&
      ...
      (function(e) {
        ...
        function n(e) {
          ...
          return (
            Ri.defined(t) &&
            Ri.typedArray(t.diagnostics, Mr.is) &&
            (void 0 === t.only || Ri.typedArray(t.only, Ri.string))
          );
        }
        (e.create = t), (e.is = n);
      })(Ai || (Ai = {})),
      (function(e) {
        ...
        function n(e) {
          ...
          return (
            t &&
            Ri.string(t.title) &&
            (void 0 === t.diagnostics || Ri.typedArray(t.diagnostics, Mr.is)) &&
            (void 0 === t.kind || Ri.string(t.kind)) &&
            (void 0 !== t.edit || void 0 !== t.command) &&
            (void 0 === t.command || Rr.is(t.command)) &&
            (void 0 === t.isPreferred || Ri['boolean'](t.isPreferred)) &&
            (void 0 === t.edit || Kr.is(t.edit))
          );
        }
        (e.create = t), (e.is = n);
      })(Ei || (Ei = {})),
      (function(e) {
        function t(e, t) {
          var n = { range: e };
          return Ri.defined(t) && (n.data = t), n;
        }
        function n(e) {
          var t = e;
          return (
            Ri.defined(t) &&
            kr.is(t.range) &&
            (Ri.undefined(t.command) || Rr.is(t.command))
          );
        }
        (e.create = t), (e.is = n);
      })(Ni || (Ni = {})),
      (function(e) {
        ...
        function n(e) {
          ...
          return (
            Ri.defined(t) &&
            Ri.uinteger(t.tabSize) &&
            Ri['boolean'](t.insertSpaces)
          );
        }
        (e.create = t), (e.is = n);
      })(Li || (Li = {})),
      (function(e) {
        ...
        function n(e) {
          ...
          return (
            Ri.defined(t) &&
            kr.is(t.range) &&
            (Ri.undefined(t.target) || Ri.string(t.target))
          );
        }
        (e.create = t), (e.is = n);
      })(Ti || (Ti = {})),
    ...
    (function(e) {
      ...
      function n(e) {
        ...
        return !!(
          Ri.defined(t) &&
          Ri.string(t.uri) &&
          (Ri.undefined(t.languageId) || Ri.string(t.languageId)) &&
          Ri.uinteger(t.lineCount) &&
          Ri.func(t.getText) &&
          Ri.func(t.positionAt) &&
          Ri.func(t.offsetAt)
        );
      }
      function r(e, t) {
        ...
        return (
          ...
          (e.prototype.positionAt = function(e) {
            ...
            var t = this.getLineOffsets(),
              n = 0,
              r = t.length;
            if (0 === r) return Cr.create(0, e);
            while (n < r) {
              var i = Math.floor((n + r) / 2);
              t[i] > e ? (r = i) : (n = i + 1);
            }
            var o = n - 1;
            return Cr.create(o, e - t[o]);
          }),
          ...
          (e.prototype.getLineOffsets = function() {
            return (
              void 0 === this._lineOffsets &&
                (this._lineOffsets = qi(this._content, !0)),
              this._lineOffsets
            );
          }),
          (e.prototype.positionAt = function(e) {
    ...
    (function(e) {
      ...
      function n(e, t, n) {
        if (e instanceof Vi) return e.update(t, n), e;
        throw new Error(
      ...
      (function(e) {
        e.LATEST = {
          textDocument: {
            completion: {
              completionItem: {
                documentationFormat: [ai.Markdown, ai.PlainText],
    ...
    var so = (function() {
        ...
        return (
          ...
          (e.prototype.include = function(e) {
            return (
              (-1 === this.focusOffset || mo(e, this.focusOffset)) &&
              e !== this.exclude
            );
          }),
    ...
    var go = (function() {
      ...
      return (
        (e.prototype.getNodeFromOffset = function(e, t) {
          if ((void 0 === t && (t = !1), this.root)) return Yr(this.root, e, t);
        }),
        ...
        (e.prototype.validate = function(e, t, n) {
          if ((void 0 === n && (n = Or.Warning), this.root && t)) {
            var r = new co();
            return (
              po(this.root, t, r, uo.instance),
        ...
        (e.prototype.getMatchingSchemas = function(e, t, n) {
          void 0 === t && (t = -1);
          var r = new so(t, n);
          return this.root && e && po(this.root, e, new co(), r), r.schemas;
        }),
        e
      );
    })();
    function po(e, t, n, r) {
        ...
        var m = function(e, t) {
          for (var o = [], a = void 0, s = 0, u = e; s < u.length; s++) {
            var c = u[s],
              ...
              f = new co(),
              h = r.newSub();
            if ((po(i, l, f, h), f.hasProblems() || o.push(l), a))
              if (t || f.hasProblems() || a.validationResult.hasProblems()) {
                var d = f.compare(a.validationResult);
                d > 0
        ...
        var g = function(e) {
          ...
          p = function(e, t, n) {
            var o = ao(e),
              a = new co(),
              s = r.newSub();
            po(i, o, a, s), r.merge(s), a.hasProblems() ? n && g(n) : t && g(t);
          },
          v = ao(t['if']);
        if ((v && p(v, ao(t.then), ao(t['else'])), Array.isArray(t['enum']))) {
          for (var y = fo(i), b = !1, _ = 0, C = t['enum']; _ < C.length; _++) {
            var k = C[_];
            if (Qr(y, k)) {
              b = !0;
              break;
      ...
      function a(e, t, n, r) {
        ...
        var g = f(t.maximum, t.exclusiveMaximum);
        Xr(g) &&
          i > g &&
          n.problems.push({
            location: { offset: e.offset, length: e.length },
            ...
            case 'uri-reference':
              ...
              if (e.value) {
                ...
                a
                  ...
                  : (o = Ji('uriMissing', 'URI is expected.'));
              } else o = Ji('uriEmpty', 'URI expected.');
              o &&
                n.problems.push({
                  location: { offset: e.offset, length: e.length },
                  message:
                    t.patternErrorMessage ||
                    t.errorMessage ||
                    Ji('uriFormatWarning', 'String is not a URI: {0}', o),
                });
              break;
            case 'color-hex':
            case 'date-time':
      ...
      function u(e, t, n, r) {
        if (Array.isArray(t.items)) {
          for (var i = t.items, o = 0; o < i.length; o++) {
            var a = i[o],
              ...
              c = e.items[o];
            c
              ? (po(c, s, u, r), n.mergePropertyMatch(u))
          ...
          if (e.items.length > i.length)
            if ('object' === typeof t.additionalItems)
              for (var l = i.length; l < e.items.length; l++) {
                u = new co();
                po(e.items[l], t.additionalItems, u, r),
          ...
          if (f)
            for (var h = 0, d = e.items; h < d.length; h++) {
              (c = d[h]), (u = new co());
              po(c, f, u, r), n.mergePropertyMatch(u);
            }
        }
        var m = ao(t.contains);
        if (m) {
          var g = e.items.some(function(e) {
            var t = new co();
            return po(e, m, t, uo.instance), !t.hasProblems();
          });
          g ||
            n.problems.push({
              location: { offset: e.offset, length: e.length },
        ...
        if (
          ...
          v &&
            n.problems.push({
              location: { offset: e.offset, length: e.length },
              message: Ji('uniqueItemsWarning', 'Array has duplicate items.'),
            });
        }
      }
      function c(e, t, n, r) {
          ...
          for (var p = 0, v = Object.keys(t.properties); p < v.length; p++) {
            ...
            if (b)
              if (ei(y))
                ...
                var _ = new co();
                po(b, y, _, r), n.mergePropertyMatch(_);
              }
          }
        if (t.patternProperties)
          for (
            var C = 0, k = Object.keys(t.patternProperties);
            C < k.length;
            C++
          )
            for (
              var S = k[C], w = new RegExp(S), x = 0, A = o.slice(0);
              x < A.length;
              x++
            ) {
              h = A[x];
        ...
        if ('object' === typeof t.additionalProperties)
          for (var E = 0, N = o; E < N.length; E++) {
            ...
            if (b) {
              _ = new co();
              po(b, t.additionalProperties, _, r), n.mergePropertyMatch(_);
            }
          }
        ...
        if (
          ...
          for (var O = 0, I = Object.keys(t.dependencies); O < I.length; O++) {
            ...
            var P = i[c];
            if (P) {
              var M = t.dependencies[c];
              if (Array.isArray(M))
                for (var R = 0, j = M; R < j.length; R++) {
                  var D = j[R];
                  i[D]
                    ? n.propertiesValueMatches++
                    : n.problems.push({
                ...
                if (y) {
                  _ = new co();
                  po(e, y, _, r), n.mergePropertyMatch(_);
                }
              }
            }
          }
        var F = ao(t.propertyNames);
        if (F)
          for (var U = 0, V = e.properties; U < V.length; U++) {
            var W = V[U];
            c = W.keyNode;
            c && po(c, F, n, uo.instance);
          }
      }
    }
    function vo(e, t) {
      ...
      function u(t, i, o, a, s) {
        if ((void 0 === s && (s = Or.Error), 0 === n.length || o !== r)) {
          var u = kr.create(e.positionAt(o), e.positionAt(a));
          n.push(Mr.create(u, t, s, i, e.languageId)), (r = o);
        }
      }
      ...
      function l() {
        switch (o.getTokenError()) {
          case 4:
            return (
              c(
                Ji('InvalidUnicode', 'Invalid unicode sequence in string.'),
                Fi.InvalidUnicode,
              ),
              !0
            );
          ...
          case 3:
            return (
              c(
                Ji('UnexpectedEndOfNumber', 'Unexpected end of number.'),
                Fi.UnexpectedEndOfNumber,
              ),
              !0
            );
          case 1:
            return (
              c(
                Ji('UnexpectedEndOfComment', 'Unexpected end of comment.'),
                Fi.UnexpectedEndOfComment,
              ),
              !0
            );
          case 2:
            return (
              c(
                Ji('UnexpectedEndOfString', 'Unexpected end of string.'),
                Fi.UnexpectedEndOfString,
              ),
              !0
            );
          case 6:
      ...
      function h(e) {
        if (3 === o.getToken()) {
          var t = new to(e, o.getTokenOffset());
          s();
          var n = !1;
          while (4 !== o.getToken() && 17 !== o.getToken()) {
            if (5 === o.getToken()) {
              n || c(Ji('ValueExpected', 'Value expected'), Fi.ValueExpected);
              var r = o.getTokenOffset();
              if ((s(), 4 === o.getToken())) {
                n &&
                  u(
                    Ji('TrailingComma', 'Trailing comma'),
                    Fi.TrailingComma,
                    r,
                    r + 1,
                  );
              ...
              n && c(Ji('ExpectedComma', 'Expected comma'), Fi.CommaExpected);
            var i = b(t);
            i
              ? t.items.push(i)
              : c(
                  Ji('PropertyExpected', 'Value expected'),
                  Fi.ValueExpected,
                  void 0,
                  [],
                  [4, 5],
          ...
          return 4 !== o.getToken()
            ? c(
                Ji('ExpectedCloseBracket', 'Expected comma or closing bracket'),
                Fi.CommaOrCloseBacketExpected,
                t,
              )
            : f(t, !0);
        }
      }
      var d = new ro(void 0, 0, 0);
      function m(t, n) {
        var r = new io(t, o.getTokenOffset(), d),
          i = p(r);
        if (!i) {
          if (16 !== o.getToken()) return;
          c(
            Ji('DoubleQuotesExpected', 'Property keys must be doublequoted'),
            Fi.Undefined,
          );
          var a = new ro(r, o.getTokenOffset(), o.getTokenLength());
        ...
        if (
          (l
            ? (u(
                Ji('DuplicateKeyWarning', 'Duplicate object key'),
                Fi.DuplicateKey,
                r.keyNode.offset,
          ...
          (c(Ji('ColonExpected', 'Colon expected'), Fi.ColonExpected),
          10 === o.getToken() &&
        ...
        return f
          ...
          : c(
              Ji('ValueExpected', 'Value expected'),
              Fi.ValueExpected,
              r,
              [],
              [2, 5],
      ...
      function g(e) {
        if (1 === o.getToken()) {
          var t = new oo(e, o.getTokenOffset()),
          ...
          while (2 !== o.getToken() && 17 !== o.getToken()) {
            if (5 === o.getToken()) {
              r ||
                c(
                  Ji('PropertyExpected', 'Property expected'),
                  Fi.PropertyExpected,
                );
              ...
              r && c(Ji('ExpectedComma', 'Expected comma'), Fi.CommaExpected);
            var a = m(t, n);
            a
              ? t.properties.push(a)
              : c(
          ...
          return 2 !== o.getToken()
            ? c(
                Ji('ExpectedCloseBrace', 'Expected comma or closing brace'),
                Fi.CommaOrCloseBraceExpected,
                t,
              )
            : f(t, !0);
        }
      ...
      function p(e) {
        if (10 === o.getToken()) {
          var t = new ro(e, o.getTokenOffset());
          return (t.value = o.getTokenValue()), f(t, !0);
        }
      }
      function v(e) {
        if (11 === o.getToken()) {
          var t = new no(e, o.getTokenOffset());
          if (0 === o.getTokenError()) {
            ...
            try {
              ...
              if (!Xr(r))
                return c(
                  Ji('InvalidNumberFormat', 'Invalid number format.'),
                  Fi.Undefined,
                  t,
                );
              t.value = r;
      ...
      function y(e) {
        switch (o.getToken()) {
          case 7:
            return f(new Zi(e, o.getTokenOffset()), !0);
          case 8:
            return f(new eo(e, !0, o.getTokenOffset()), !0);
          case 9:
            return f(new eo(e, !1, o.getTokenOffset()), !0);
          default:
            return;
        }
      }
      function b(e) {
        return h(e) || g(e) || p(e) || v(e) || y(e);
      }
      var _ = void 0,
        C = s();
      return (
        17 !== C &&
          ...
          _
            ? 17 !== o.getToken() &&
              c(
                Ji('End of file expected', 'End of file expected.'),
                Fi.Undefined,
              )
            : c(
                Ji(
    ...
    function yo(e, t, n) {
      if (null !== e && 'object' === typeof e) {
        ...
        for (i = '{\n', o = 0; o < a.length; o++) {
          var s = a[o];
          (i += r + JSON.stringify(s) + ': ' + yo(e[s], r, n)),
            o < a.length - 1 && (i += ','),
            (i += '\n');
        }
        return (i += t + '}'), i;
      ...
      xo = (function() {
        ...
        return (
              ...
              m = {
                add: function(e) {
                  ...
                  if (n)
                    ...
                    c &&
                      void 0 !== e.insertText &&
                      (e.textEdit = jr.replace(c, e.insertText)),
                      h &&
                        (e.commitCharacters = e.kind === ui.Property ? wo : So),
                      (e.label = t),
                      (d[t] = e),
                      i.items.push(e);
                  }
              ...
              .then(function(t) {
                ...
                if (s && 'object' === s.type) {
                  ...
                  v.forEach(function(e) {
                    (g && g === e) || (d[e.keyNode.value] = di.create('__'));
                  });
                  var y = '';
                  f && (y = r.evaluateSeparatorAfter(e, e.offsetAt(c.end))),
                    t
                      ? r.getPropertyCompletions(t, n, s, f, y, m)
                      : r.getSchemaLessPropertyCompletions(n, s, h, m);
                  var b = ho(s);
                ...
                return (
                  t
                    ? r.getValueCompletions(t, n, s, a, e, m, _)
                    : r.getSchemaLessValueCompletions(n, s, a, e, m),
                  r.contributions.length > 0 &&
                    r.getContributedValueCompletions(n, s, a, e, m, u),
                  r.promiseConstructor.all(u).then(function() {
                    if (0 === m.getNumberOfProposals()) {
                      ...
                      r.addFillerValueCompletions(_, n, m);
                    }
                    return i;
                  })
                );
                  ...
                  if (g.node === n && !g.inverted && g.schema) {
                    if ('array' === n.type && g.schema.items)
                      if (Array.isArray(g.schema.items)) {
                        ...
                        this.addSchemaValueCompletions(g.schema.items, f, o, a);
                    if (void 0 !== u) {
                      var v = !1;
                      ...
                      if (g.schema.patternProperties && !v)
                        for (
                          var b = 0,
                            _ = Object.keys(g.schema.patternProperties);
                          b < _.length;
                          b++
                        ) {
                          var C = _[b],
                          ...
                          if (k.test(u)) {
                            v = !0;
                            y = g.schema.patternProperties[C];
                            this.addSchemaValueCompletions(y, f, o, a);
                          }
                        }
          ...
          (e.prototype.addDefaultValueCompletions = function(e, t, n, r) {
            ...
            if (Zr(e['default'])) {
              ...
              n.add({
                ...
                insertTextFormat: ci.Snippet,
                detail: ko('json.suggest.default', 'Default value'),
              }),
                (o = !0);
            }
          ...
          (e.prototype.collectTypes = function(e, t) {
            if (!Array.isArray(e['enum']) && !Zr(e['const'])) {
              var n = e.type;
              Array.isArray(n)
          ...
          (e.prototype.addFillerValueCompletions = function(e, t, n) {
            e['object'] &&
              n.add({
                ...
                insertTextFormat: ci.Snippet,
                detail: ko('defaults.object', 'New object'),
                documentation: '',
              }),
              e['array'] &&
                n.add({
                  ...
                  insertText: this.getInsertTextForGuessedValue([], t),
                  insertTextFormat: ci.Snippet,
                  detail: ko('defaults.array', 'New array'),
                  documentation: '',
                });
          }),
            ...
            if (t) {
              if (Array.isArray(t.defaultSnippets)) {
                if (1 === t.defaultSnippets.length) {
                  ...
                  Zr(u) && (o = this.getInsertTextForSnippetValue(u, ''));
                }
          ...
          (e.prototype.findItemAtOffset = function(e, t, n) {
            for (
              var r = $r(t.getText(), !0), i = e.items, o = i.length - 1;
              o >= 0;
              o--
            ) {
              var a = i[o];
          ...
          (e.prototype.fromMarkup = function(e) {
            if (e && this.doesSupportMarkdown())
              return { kind: ai.Markdown, value: e };
          }),
          (e.prototype.doesSupportMarkdown = function() {
            if (!Zr(this.supportsMarkdown)) {
              var e =
              ...
              this.supportsMarkdown =
                ...
                -1 !==
                  e.completionItem.documentationFormat.indexOf(ai.Markdown);
            }
            return this.supportsMarkdown;
          }),
          (e.prototype.doesSupportsCommitCharacters = function() {
            if (!Zr(this.supportsCommitCharacters)) {
              var e =
                this.clientCapabilities.textDocument &&
                this.clientCapabilities.textDocument.completion;
          ...
          try {
            for (var n = 0, r = e; n < r.length; n++) {
              var i = r[n],
                o = '!' !== i[0];
              o || (i = i.substring(1)),
                this.patternRegExps.push(new RegExp(Co(i) + '$')),
      ...
      Io = (function() {
        function e(e, t, n) {
          (this.service = e),
            ...
            (this.dependencies = {}),
            n &&
              (this.unresolvedSchema = this.service.promise.resolve(new Po(n)));
        }
        return (
        ...
        return (
          ...
          (e.prototype.loadSchema = function(e) {
            if (!this.requestService) {
              ...
              return this.promise.resolve(new Po({}, [t]));
            }
          ...
          (e.prototype.getSchemaForResource = function(e, t) {
            ...
            for (
              ...
              if (f.matchesPattern(u))
                for (var h = 0, d = f.getURIs(); h < d.length; h++) {
                  var m = d[h];
                  a[m] || (s.push(m), (a[m] = !0));
                }
            }
          ...
          (e.prototype.getMatchingSchemas = function(e, t, n) {
            if (n) {
              var r =
                n.id || 'schemaservice://untitled/matchingSchemas/' + jo++;
              return this.resolveSchemaContent(new Po(n), r, {}).then(function(
                e,
              ) {
        ...
        return (
          (e.prototype.configure = function(e) {
            e &&
              ...
              (this.commentSeverity = e.allowComments ? void 0 : Or.Error));
          }),
          (e.prototype.doValidation = function(e, t, n, r) {
            ...
            var o = [],
              ...
              u = function(r) {
                var a = n ? $o(n.trailingCommas) : Or.Error,
                  u = n ? $o(n.comments) : i.commentSeverity,
                  c = (null === n || void 0 === n
                  ? void 0
                  : n.schemaValidation)
                    ? $o(n.schemaValidation)
                    : Or.Warning,
                  l = (null === n || void 0 === n
                  ? void 0
                  : n.schemaRequest)
                ...
                if (r) {
                  if (r.errors.length && t.root && l) {
                    ...
                    if (h && '$schema' === h.keyNode.value) {
                      ...
                      s(Mr.create(m, r.errors[0], l, Fi.SchemaResolveError));
                    } else {
                      m = kr.create(
                  ...
                  Bo(r.schema) && (u = void 0), Ko(r.schema) && (a = void 0);
                }
                for (var p = 0, v = t.syntaxErrors; p < v.length; p++) {
                  var y = v[p];
                  if (y.code === Fi.TrailingComma) {
                ...
                if ('number' === typeof u) {
                  ...
                  t.comments.forEach(function(e) {
                    s(Mr.create(e, b, u, Fi.CommentNotPermitted));
                  });
                }
                return o;
              };
            if (r) {
              var c = r.id || 'schemaservice://untitled/' + qo++;
              return this.jsonSchemaService
                .resolveSchemaContent(new Po(r), c, {})
                .then(function(e) {
                  return u(e);
                });
            }
    ...
    function Bo(e) {
      if (e && 'object' === typeof e) {
        if (ei(e.allowComments)) return e.allowComments;
        if (e.allOf)
    ...
    function Ko(e) {
      if (e && 'object' === typeof e) {
        if (ei(e.allowTrailingCommas)) return e.allowTrailingCommas;
        var t = e;
        if (ei(t['allowsTrailingCommas'])) return t['allowsTrailingCommas'];
        if (e.allOf)
    ...
    function Qo(e) {
      return e < Ho
        ...
        : e <= Yo
        ? e - Ho
        : (e < zo && (e += zo - Go), e >= zo && e <= Jo ? e - zo + 10 : 0);
    }
    function Xo(e) {
      if ('#' === e[0])
        switch (e.length) {
          case 4:
            return {
              red: (17 * Qo(e.charCodeAt(1))) / 255,
              green: (17 * Qo(e.charCodeAt(2))) / 255,
              blue: (17 * Qo(e.charCodeAt(3))) / 255,
              alpha: 1,
            };
          case 5:
            return {
              ...
              green: (17 * Qo(e.charCodeAt(2))) / 255,
              blue: (17 * Qo(e.charCodeAt(3))) / 255,
              alpha: (17 * Qo(e.charCodeAt(4))) / 255,
            };
          case 7:
            return {
              red: (16 * Qo(e.charCodeAt(1)) + Qo(e.charCodeAt(2))) / 255,
              green: (16 * Qo(e.charCodeAt(3)) + Qo(e.charCodeAt(4))) / 255,
              blue: (16 * Qo(e.charCodeAt(5)) + Qo(e.charCodeAt(6))) / 255,
              alpha: 1,
            };
          case 9:
            return {
              ...
              green: (16 * Qo(e.charCodeAt(3)) + Qo(e.charCodeAt(4))) / 255,
              blue: (16 * Qo(e.charCodeAt(5)) + Qo(e.charCodeAt(6))) / 255,
              alpha: (16 * Qo(e.charCodeAt(7)) + Qo(e.charCodeAt(8))) / 255,
            };
        }
    }
    var Zo = (function() {
      ...
      return (
        (e.prototype.findDocumentSymbols = function(e, t, n) {
          ...
          if (
            ('vscode://defaultsettings/keybindings.json' === a ||
              _o(a.toLowerCase(), '/user/keybindings.json')) &&
            'array' === i.type
          ) {
        ...
        (e.prototype.findDocumentSymbols2 = function(e, t, n) {
          ...
          return (
            b && n && n.onResultLimitExceeded && n.onResultLimitExceeded(a), p
          );
        }),
        ...
        (e.prototype.getColorPresentations = function(e, t, n, r) {
          ...
          return (
            ...
            o.push({ label: i, textEdit: jr.replace(r, JSON.stringify(i)) }),
            o
          );
        }),
        e
    ...
    var ta = Yi(),
      ...
      ra = {
        id: ta('schema.json.id', 'A unique identifier for the schema.'),
        $schema: ta(
          'schema.json.$schema',
          'The schema to verify this document against.',
        ),
        title: ta('schema.json.title', 'A descriptive title of the element.'),
        description: ta(
        ...
        not: ta('schema.json.not', 'A schema which must not match.'),
        $id: ta('schema.json.$id', 'A unique identifier for the schema.'),
        $ref: ta(
          'schema.json.$ref',
    ...
    for (var ia in na.schemas) {
      var oa = na.schemas[ia];
      for (var aa in oa.properties) {
        var sa = oa.properties[aa];
        'boolean' === typeof sa && (sa = oa.properties[aa] = {});
        var ua = ra[aa];
        ua
          ? (sa['description'] = ua)
          : console.log(aa + ": localize('schema.json." + aa + '\', "")');
      }
    }
    function ca(e, t) {
      var n = [],
      ...
      while (17 !== s) {
        switch (s) {
          case 1:
          case 3:
            var c = e.positionAt(a.getTokenOffset()).line,
              l = {
                startLine: c,
                endLine: c,
          ...
          case 4:
            ...
            break;
          case 13:
            c = e.positionAt(a.getTokenOffset()).line;
            var d = e.positionAt(a.getTokenOffset() + a.getTokenLength()).line;
            1 === a.getTokenError() && c + 1 < e.lineCount
              ? a.setPosition(e.offsetAt(Cr.create(c + 1, 0)))
              : c < d &&
                (u({ startLine: c, endLine: d, kind: Nr.Comment }), (o = c));
            break;
          case 12:
            ...
            if (g) {
              ...
              if (g[1]) {
                l = { startLine: h, endLine: h, kind: Nr.Region };
                i.push(l);
              } else {
                var p = i.length - 1;
                while (p >= 0 && i[p].kind !== Nr.Region) p--;
                if (p >= 0) {
                  l = i[p];
                  (i.length = p),
                    h > l.startLine &&
      ...
      function r(t) {
        ...
        while (o) {
          switch (o.type) {
            ...
            case 'array':
              var u = o.offset + 1,
                c = o.offset + o.length - 1;
              u < c && r >= u && r <= c && s.push(i(u, c)),
                s.push(i(o.offset, o.offset + o.length));
              break;
            case 'number':
            case 'boolean':
            case 'null':
          ...
          if (
            ...
            var l = a(o.offset + o.length, 5);
            -1 !== l && s.push(i(o.offset, l));
          }
          o = o.parent;
        }
        for (var f = void 0, h = s.length - 1; h >= 0; h--)
          f = Oi.create(s[h], f);
        return f || (f = Oi.create(kr.create(t, t))), f;
      }
      function i(t, n) {
        return kr.create(e.positionAt(t), e.positionAt(n));
      }
      var o = $r(e.getText(), !0);
      function a(e, t) {
        o.setPosition(e);
        ...
        t.visit(function(r) {
          ...
          if (
            ...
            if (a) {
              ...
              n.push({
                target: e.uri + '#' + (s.line + 1) + ',' + (s.character + 1),
                range: ha(e, r.valueNode),
              });
            }
          }
          return !0;
    ...
    function va(e) {
      var t = e.promiseConstructor || Promise,
        n = new Ro(e.schemaRequestService, e.workspaceContext, t);
      n.setSchemaContributions(na);
      var r = new xo(n, e.contributions, t, e.clientCapabilities),
        i = new Ao(n, e.contributions, t),
        o = new Zo(n),
        a = new Wo(n, t);
      return {
        ...
        format: function(e, t, n) {
          ...
          return Jr(e.getText(), r, a).map(function(t) {
            return jr.replace(
              kr.create(
                e.positionAt(t.offset),
                e.positionAt(t.offset + t.length),
    ...
    var Ca = (function() {
        function e(e, t) {
          (this._ctx = e),
            ...
            (this._languageService = va({
              ...
              schemaRequestService: t.enableSchemaRequest && ya,
            })),
        ...
        return (
          ...
          (e.prototype._getTextDocument = function(e) {
            for (
              var t = this._ctx.getMirrorModels(), n = 0, r = t;
              n < r.length;
              n++
            ) {
              var i = r[n];
              if (i.uri.toString() === e)
                return Di.create(e, this._languageId, i.version, i.getValue());
            }
            return null;
          }),
          e
      ...
      Sa = '.'.charCodeAt(0);
    function wa(e) {
      return e.charCodeAt(0) === ka;
    }
    function xa(e, t) {
      if (wa(t)) {
        var n = Lo['a'].parse(e),
          r = t.split('/');
        return n['with']({ path: Aa(r) }).toString();
      }
      return Ea(e, t);
    }
    function Aa(e) {
      for (var t = [], n = 0, r = e; n < r.length; n++) {
        var i = r[n];
        0 === i.length ||
          (1 === i.length && i.charCodeAt(0) === Sa) ||
          (2 === i.length && i.charCodeAt(0) === Sa && i.charCodeAt(1) === Sa
            ? t.pop()
            : t.push(i));
      }
    ...
    function Ea(e) {
      for (var t = [], n = 1; n < arguments.length; n++)
        t[n - 1] = arguments[n];
      for (
        var r = Lo['a'].parse(e), i = r.path.split('/'), o = 0, a = t;
        o < a.length;
        o++
      ) {
        var s = a[o];
      ...
      return r['with']({ path: Aa(i) }).toString();
    }
  ...
  MNsG: function(e, t, n) {
    ...
    (function(e, r) {
      ...
      var o = 'en',
        ...
        l = void 0,
        f = void 0,
        h = 'object' === typeof self ? self : 'object' === typeof e ? e : {},
        d = void 0;
      'undefined' !== typeof r
        ? (d = r)
        : 'undefined' !== typeof h.vscode && (d = h.vscode.process);
      var m =
          'string' ===
            typeof (null ===
      ...
      if ('object' !== typeof navigator || m)
        if ('object' === typeof d) {
          (a = 'win32' === d.platform),
            ...
            (l = o),
            o;
          var p = d.env['VSCODE_NLS_CONFIG'];
          if (p)
            try {
              var v = JSON.parse(p),
                y = v.availableLanguages['*'];
              (l = v.locale), y || o, v._translationsConfigFile;
            } catch (w) {}
          !0;
        } else console.error('Unable to resolve platform.');
      else
        (f = navigator.userAgent),
          (a = f.indexOf('Windows') >= 0),
          (s = f.indexOf('Macintosh') >= 0),
  ...
  VWci: function(e, t, n) {
    var r = (function(e) {
      ...
      var C = (v.prototype = g.prototype = Object.create(y));
      function k(e) {
      ...
      return (
        (p.prototype = C.constructor = v),
        (v.constructor = p),
        (v[s] = p.displayName = 'GeneratorFunction'),
          ...
          var t = {
              470: function(t) {
                ...
                var i = {
                  resolve: function() {
                    for (
                      var t, i = '', o = !1, a = arguments.length - 1;
                      a >= -1 && !o;
                      a--
                    ) {
                      var s;
                  ...
                  relative: function(e, t) {
                    ...
                    for (
                      var u = t.length - s, c = a < u ? a : u, l = -1, f = 0;
                      f <= c;
                      ++f
                    ) {
                      if (f === c) {
                        if (u > c) {
                          if (47 === t.charCodeAt(s + f))
                            return t.slice(s + f + 1);
